...
'LBL_MODULE_TITLE'=>'Customers: Home',
'LBL_SEARCH_FORM_TITLE'=>'Customer Search',
'LBL_LIST_FORM_TITLE'=>'Customer List',
'LBL_NEW_FORM_TITLE'=>'New Customer',
'LBL_MEMBER_ORG_FORM_TITLE'=>'Member Customers',
// Label for Top Customers in Home Page, added for 4.2 GA
'LBL_TOP_ACCOUNTS'=>'My Top Customers',
...
'LBL_ACCOUNT_INFORMATION'=>'Customer Information',
...
'LBL_DUPLICATE'=>'Potential Duplicate Customers',
'MSG_DUPLICATE' => 'Creating this vtiger_account may vtiger_potentialy create a duplicate vtiger_account. You may either select an vtiger_account from the list below or you may click on Create New Customer to continue creating a new vtiger_account with the previously entered data.',

'LBL_INVITEE'=>'Contacts',
'ERR_DELETE_RECORD'=>"A record number must be specified to delete the vtiger_account.",

'LBL_SELECT_ACCOUNT'=>'Select Customer',
...
// Added for 4GA
'LBL_TOOL_FORM_TITLE'=>'Customer Tools',
//Added for 4GA
...
'LBL_ACCOUNT_EXIST' => 'Customer Name Already Exists!',
...
'LBL_MAILER_EXPORT_RESULTS_DESCR'=>'The data will gathered from the Customers and their Contacts, that were returned
 from the previous search.',
'LBL_EXPORT_RESULTS_EMAIL' => 'Export E-Mailer data',
'LBL_EXPORT_RESULTS_EMAIL_CORP'=>'Export E-Mail data, using "Company Email" from the Customer if the Contacts "Email" is empty',
'LBL_EXPORT_RESULTS_FULL'=>'Export data with the Contacts, E-Mail, Customer name, Address, Telephone, etc.',
...
'LBL_SHOW_ACCOUNT_HIERARCHY' => 'Show Customer Hierarchy',
