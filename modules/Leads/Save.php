...
echo "company name before".$focus->column_fields['company']."<br>";*/
$focus->column_fields['company'] = $_POST['account_name'];
/*echo "company name after ".$focus->column_fields['company']."<br>";

echo"<pre>after";print_r($focus);echo"</pre>"; die;*/
