...
(
    ...
    [lastname] => Williams
    [mobile] => (109) 936-6462
    [company] => Edfg group limited
    [fax] => 
    [designation] => Mgr Operations
    [email] => linda_williams@company.com
    [leadsource] => Direct Mail
    [website] => www.edfggrouplimited.com
    [industry] => 
    [leadstatus] => Cold
    [annualrevenue] => 0
    [rating] => Shutdown
    ...
    [assigned_user_id] => 1
    [secondaryemail] => 
    [createdtime] => 2013-08-18 00:04:04
    [modifiedtime] => 2013-08-18 00:04:04
    [modifiedby] => 1
    [lane] => 1715 Scott Dr
    [code] => 99999
    [city] => San Jose
...
{
	//echo"col_fields -> ".print_r($col_fields)."<br>";
	...
	elseif($uitype == 53)
	{
		...
		else
		{
			...
			//echo"Notok ";$result = get_group_options();
		}
	//	echo"the value is ".$$value."<br>";
		...
		if($value != '' && $value != 0)
			...
			if($value=='0'){
				...
				//echo"val is not 0--<br>";
				$assigned_user_id = $current_user->id;
			}
				
		}
		 echo" uitype is ".$uitype."<br>";
		// echo"module name ".$module_name."<br>";
		// echo" is_admin ".$is_admin."<br>";
	//	echo"<pre>profileGlobalPermission ";print_r($profileGlobalPermission);echo"</pre>";echo"<br>";

		//echo"defaultOrgSharingPermission ".$defaultOrgSharingPermission[getTabid($module_name)]."<br>";
	//	 $users_combo=get_select_options_array(get_user_array(FALSE, "Active", $assigned_user_id,'private'), $assigned_user_id);
				 

		
	//	$users_combo=get_select_options_array(get_user_array(FALSE, "Active", $assigned_user_id,'private'), $assigned_user_id);	 
	//	echo"private ";echo"<pre>";print_r($users_combo);echo"</pre>";echo"<br>";	
		if($fieldname == 'assigned_user_id' && $is_admin==false && $profileGlobalPermission[2] == 1 && ($defaultOrgSharingPermission[getTabid($module_name)] == 3 or $defaultOrgSharingPermission[getTabid($module_name)] == 0))
		{
			$users_combo = get_select_options_array(get_user_array(FALSE, "Active", $assigned_user_id,'private'), $assigned_user_id);
		//	echo"private ";echo"<pre>";print_r($users_combo);echo"</pre>";echo"<br>";
		...
		{
			$users_combo = get_select_options_array(get_user_array(FALSE, "Active", $assigned_user_id), $assigned_user_id);
		//	echo"Public inside ";echo"<pre>";print_r($users_combo);echo"</pre>";echo"<br>";
		}
