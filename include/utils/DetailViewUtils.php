...
//	echo "uitype ".$uitype."<br>"; die;
	...
	//	echo"company ".$col_fields['company']."<br>";
	//	echo"account_id ".$account_id."<br>";
			
		if ($col_fields['company']!='')
		{
			$account_id = getAccountId($col_fields['company']);
			echo"account_id ".$account_id;
			echo"<br>";
			$label_fld[] = getTranslatedString($fieldlabel, $module);
			$account_name=$col_fields['company'];
			...
			/*echo $label_fld[] = getTranslatedString($fieldlabel, $module);
			echo"<br>";
			echo"account_name ". $label_fld[] = $account_name;
			echo"<br>";
			echo"secid ". $label_fld["secid"] = $account_id;
			echo"<br>";
			echo $label_fld["link"] = "index.php?module=Accounts&action=DetailView&record=" . $account_id;
			echo"<br>";*/
		...
		//echo"in DetailViewUtils.php "; die;
		//Account Name View
		...
		//echo"<pre>";print_r($label_fld);echo"</pre>"; die;
