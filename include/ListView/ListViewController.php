...
class ListViewController {
	...
	//	echo"module is ".$module."<br>"; 
		...
		//echo"<pre>";print_r($whereFields);echo"</pre>"; die;
		$meta = $this->queryGenerator->getMeta($this->queryGenerator->getModule());

		$moduleFields = $meta->getModuleFields();
		//echo"<pre>";print_r($moduleFields);echo"</pre>"; die;
		$accessibleFieldList = array_keys($moduleFields);
		$listViewFields = array_intersect($fields, $accessibleFieldList);
		//echo"<pre>tes";print_r($listViewFields);echo"</pre>"; 
		...
		foreach ($listViewFields as $fieldName) {
			$field = $moduleFields[$fieldName];
				//echo "data type ".$field->getFieldDataType()."<br>"; 
		...
		for ($i = 0; $i < $rowCount; ++$i) {
			...
			//echo"<pre>after";print_r($listViewFields);echo"</pre>";
			foreach ($listViewFields as $fieldName) 
			{
				$field = $moduleFields[$fieldName];
				//echo"column name ".$field->getColumnName()."<br>";
				$uitype = $field->getUIType();
				$rawValue = $this->db->query_result($result, $i, $field->getColumnName());
				if ($field->getColumnName()== 'company')
				{
				  $account_name = 	$rawValue;
				  $accountid = getAccountId($rawValue);
				  //echo"<br>";
				  $rawValue	=$accountid;
				}

				//echo"account_id ".$rawValue."<br>";
				//echo "uitype " .$uitype."<br>";
				//echo"value  ".$value."<br>";
				...
				} elseif($field->getFieldDataType() == 'reference') 
				{
					//echo"next <br>##########<br>";
					$referenceFieldInfoList = $this->queryGenerator->getReferenceFieldInfoList();
					//echo"<pre>";print_r($referenceFieldInfoList);echo"</pre>"; 
					$moduleList = $referenceFieldInfoList[$fieldName];
				//	echo"<pre>moduleList";print_r($moduleList);echo"</pre>"; 
				//	echo"value ".$value."<br>";
				//	echo"count ".count($moduleList)."<br>";
					...
					/*echo"parentModule ".$parentModule."<br>";
					echo"fieldName ".$fieldName."<br>";
					echo"value ".$value."<br>";
					echo"fieldName ".print_r($this->nameList[$fieldName])."<br>";
					echo"textlength_check ".textlength_check($this->nameList[$fieldName][$value])."<br>";*/
					...
					//	echo "rawValue ".$rawValue;
						$value = "<a href='index.php?module=$parentModule&action=DetailView&".
								"record=$rawValue' title='".getTranslatedString($parentModule, $parentModule)."'>$account_name</a>";
	...
	public function getAdvancedSearchOptionString() {
		...
		$meta = $this->queryGenerator->getMeta($module);
//echo"<pre>";print_r($meta->getModuleFields());echo"</pre>"; die;
		$moduleFields = $meta->getModuleFields();
		$i =0;
